// Este é o script modificado para enviar o e-mail usando EmailJS
    ...
    <div class="alert bg-danger bg-opacity-10 d-flex p-3 mt-4" role="alert">
        ...
        <div class="ps-1">
            <h3 class="m-0 fw-semibold text-sm text-danger-emphasis">
                Oops! Seu mensagem não foi enviada.
            </h3>
...
myForm.addEventListener('submit', function(event) {
    ...
    if (!myForm.checkValidity()) {
        ...
        var templateParams = {
            ...
            to_email: 'suporte@topcleaning.site'  // Endereço de e-mail para o qual você quer enviar
        };
